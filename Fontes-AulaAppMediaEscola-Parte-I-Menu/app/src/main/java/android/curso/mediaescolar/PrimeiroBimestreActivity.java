...
public class PrimeiroBimestreActivity extends AppCompatActivity {
    ...
    public void salvarSharedPreferences(){
        ...
        mediaEscolar.putString("situacaoPrimeiroBimestre", txtSituacaoFinal.getText().toString());
        ...
        mediaEscolar.putString("notaMediaPrimeiroBimestre", String.valueOf(media));
